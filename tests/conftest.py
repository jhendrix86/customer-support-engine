...
def _enable_sqlite_foreign_keys(dbapi_connection, connection_record):
    ...
    without it, test_ticket_requires_a_customer would silently pass for the
    wrong reason (SQLite allowing an orphan FK, not real validation)."""
...
async def db_engine():
    ...
    from app.models import ticket, customer, agent, response, knowledge_article  # noqa: F401
